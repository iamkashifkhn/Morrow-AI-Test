...
import MarrowSM from "../../assets/images/Marrow-sm.png"
// import Marrow from "../../assets/images/Marrow.png"
            ...
            <div className="navbar-brand-box text-center">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm">
                  ...
                  <img src={MarrowSM} alt="logo-sm-dark" height="70" />
                </span>
                <span className="logo-lg">
                  {/* <img src={logoDark} alt="logo-dark" height="24" /> */}
                  {/* <img src={Marrow} alt="logo-dark" height="48" /> */}
                  <img src={MarrowAILight} alt="logo-dark" height="70" />
